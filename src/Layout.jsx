...
const STANDALONE_PAGES = new Set(["RsaScore", "RsaDashboard", "RsaJuryForm", "RsaJuryHub", "RsaJuryView", "RsaAdmin", "RsaRecap", "RsaFinaleResults", "RsaFinaleRsvp", "RsaPrintSheets", "StartupUpload", "Login", "MonDossier", "Jury", "Selection", "Admin"]);
