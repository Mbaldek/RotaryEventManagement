...
// ── Tabs ────────────────────────────────────────────────────────────────────
// Note 2026-05-29 (équipe A — drop "Outils avancés") :
//   * Le tab 'advanced' a été retiré du master cockpit. Il regroupait :
//       - Email Studio   → désormais traité dans son propre flow (équipe B).
//       - Extensions     → placeholder dev V3.1+, déplacé vers /AdminAdvanced.
//       - Marketplace    → placeholder dev V3.1+, déplacé vers /AdminAdvanced.
//   * La nouvelle page /AdminAdvanced est accessible via UserMenu (item
//     "Paramètres avancés (développeur)") visible uniquement pour master_admin.
//   * AdvancedSection.jsx reste sur disque (deprecated) pour compat éventuelle.
export const TABS = {
...
// 'advanced' RETIRÉ (2026-05-29) : voir commentaire au-dessus.
