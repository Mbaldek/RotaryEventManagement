...
const T = {
  fr: {
    ...
    formatInfo:"Format : visio Teams, ~2h30. Chaque startup : 10 à 12 min de pitch + 8 à 10 min de Q&A avec le jury (en anglais).",
  ...
  en: {
    ...
    formatInfo:"Format: Teams call, ~2h30. Each startup: 10 to 12 min pitch + 8 to 10 min Q&A with the jury (in English).",
