...
export const SESSIONS = [
  ...
  },
  {
    ...
    emoji: "🏆",
    date: "Mardi 26 mai · 16h–19h",
    dateEn: "Tuesday May 26 · 4–7pm",
    dateDe: "Dienstag, 26. Mai · 16–19 Uhr",
    venue: "Cyrus Conseil — 50 bd Haussmann, Paris 75009",
    venueNote: "Cocktail dînatoire à l'issue, ouvert à tous",
    venueNoteEn: "Cocktail reception afterwards, open to all",
    venueNoteDe: "Anschließend Cocktailempfang, für alle offen",
    color: "#c9a84c",
    light: "#fdf6e8",
    border: "#e8d090",
    isFinal: true,
